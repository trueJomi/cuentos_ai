...
def test_result_introduction_regex():
    with open("test/static/result_test.txt",encoding="utf-8") as result_raw:
...
# def test_data():
#     chat =  copy(gpt)
#     text =  chat.hadleMsgChat("promp = un cuento basado en caperucita roja que tenga por lo menos 5 parrafos, ahora escribe el texto")
#     print(text)
